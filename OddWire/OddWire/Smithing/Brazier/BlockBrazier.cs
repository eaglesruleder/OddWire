...
namespace OddWire.GameContent
{
    public class BlockBrazier : Block, IIgnitable, ISmokeEmitter
    {
        ...
        public EnumIgniteState OnTryIgniteBlock(EntityAgent byEntity, BlockPos pos, float secondsIgniting)
        {
            ...
            if (beBrazier.IsBurning || beBrazier.inventory.FuelSlot.Empty)
        ...
        public void OnTryIgniteBlockOver(EntityAgent byEntity, BlockPos pos, float secondsIgniting, ref EnumHandling handling)
        {
            ...
            && !beBrazier.IgniteByInteraction
               )
            {
                beBrazier.IgniteByInteraction = true;
        ...
        {
            if (IsExtinct
            || (manager.BlockAccess.GetBlockEntity(pos) is BlockEntityBrazier beBrazier && !beBrazier.IsWide)
                )
            {
        ...
        public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
        {
            ...
            if (OnBlockInteractStart_tryStackCombustible(world, byPlayer, beBrazier, stack)
            ||  OnBlockInteractStart_tryMealContainer(world, byPlayer, blockSel, beBrazier, stack)
            ||  OnBlockInteractStart_trySmeltingContainer(world, byPlayer, beBrazier, stack)
                )
            {
        ...
        private bool OnBlockInteractStart_tryStackCombustible(IWorldAccessor world, IPlayer byPlayer, BlockEntityBrazier beBrazier, ItemStack stack)
        {
        ...
        private bool OnBlockInteractStart_trySmeltingContainer(IWorldAccessor world, IPlayer byPlayer, BlockEntityBrazier beBrazier, ItemStack stack) =>
